                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="product-price" style="margin-left:-15px;">HARGA : <span><?php echo rp($ail['harga']); ?></span> <?php echo rp($ail['harga']*0.5);?></div>
                            </div>
                                ...
                                <div class="product">
                                    ...
                                    <div class="product-details">  
                                        ...
                                        <div class="product-price">
                                            ...
                                            <div style="font-size:18px;"><?php echo 'Rp. '. rp($dui['harga']*0.5); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
