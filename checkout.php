...
<?php if($cc!=NULL) { ?>
                    ...
                    <div class="col-md-6">
                        <!-- INI BELUM -->
                           <div class="login-form-box" style="background-color:#fff;border:3px solid#eee;">
                                <form action="prosesuser/hanuser?thisposition=<?php echo base64_encode('insert_bukti'); ?>" method="post" enctype="multipart/form-data">
                                    <h3>Upload Bukti Transfer</h3>
                                    <div class="form-group">
                                        <label>Pilih Foto</label>
                                       <input type="text" name="id_checkout" class="input-line" placeholder="ID Checkout.." value="<?= $cc['id_checkout'];?>" hidden>
