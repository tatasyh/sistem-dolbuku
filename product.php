                            ...
                            <div class="col-md-3 col-xs-4">
                                <div class="product">
                                    <div class="product-cover">
                                        <div class="product-cover-hover"><span><a href="detailproduct1?thisproduct=<?php echo base64_encode($dui['id_produk']) ?>&nameproduct=<?php echo $dui['nama']; ?>">Detail</a></span></div>
                                        <img style="width:300px;height:230px;" src="control/<?php echo $dui['gambar']; ?>" alt="product name" />
                                    </div>    
                                    <div class="product-details">    
                                        <a href="detailproduct1?thisproduct=<?php echo base64_encode($dui['id_produk']) ?>&nameproduct=<?php echo $dui['nama']; ?>"><h1 style="font-size:95%;"><?php echo $dui['nama']; ?></h1></a>
                                        ...
                                        <div class="product-price">
                                            ...
                                            <strike><div style="font-size:16px;"><?php echo 'Rp. '. rp($dui['harga']);
                                            ?></div></strike>
                                            <div style="font-size:16px;"><?php echo 'Rp. '. rp($dui['harga']*0.5);
                                            ?></div>
                                        </div>
                                    </div>
                                </div>
