...
<?php $sli=mysqli_query($con,"SELECT * FROM slider order by id_slider desc limit 6");while($der=mysqli_fetch_array($sli)){ ?>
                        <li class="slide"><img style="width:2040px;height:450px;" st src="control/<?php echo $der['gambar']; ?>" alt="slider image"></li>
<?php } ?>
                    </ul>
                            ...
                            <div class="col-md-3 col-xs-6">
                                <div class="product">
                                    ...
                                    <div class="product-details">  
                                            ...
                                            <a href="detailproduct?thisproduct=<?php echo base64_encode($dui['id_produk']) ?>&nameproduct=<?php echo $dui['nama']; ?>"><h1 style="font-size:95%;"><?php echo $dui['nama']; ?></h1></a>
...
<?php } ?>
            ...
            <div class="box">
                <div class="container">
                    ...
                    <div class="row">
<?php $lar=mysqli_query($con,"SELECT * from log order by id_log desc limit 4");while($na=mysqli_fetch_array($lar)){ $nana=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM produk where id_produk='$na[id_produk]' ")); ?>
                        <div class="col-md-6">
                            <div class="product">
                                <div class="product-cover">
                                    ...
                                    <img style="width:100px;height:150px;" src="control/<?php echo $nana['gambar']; ?>" alt="product name" />
                                </div>    
                                <div class="product-details">  
...
<?php } ?>
            ...
            <div class="box">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="site-title"><div class="site-inside"><span>Question And Answer</span></div></div> 
